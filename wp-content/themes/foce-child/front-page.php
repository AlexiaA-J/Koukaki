...
?>
    ...
    <main id="primary" class="site-main">
        ...
        <section id="#story" class="story">
            <h2> <span data-100="transform: translateY(150px); opacity:0"data-500="transform: translateY(0px); opacity:1">L'histoire</span> </h2>
        ...
        <section id="studio">
            <h2> <span data-2200="transform: translateY(250px); opacity:0"data-2500="transform: translateY(0px); opacity:1">Studio</span><span data-2250="transform: translateY(250px); opacity:0"data-2550="transform: translateY(0px); opacity:1"> Koukaki</span></h2>
            <div>
